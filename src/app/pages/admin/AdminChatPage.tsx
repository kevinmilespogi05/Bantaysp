        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="p-4">
              <EmptyState
                icon={MessageSquare}
                title={search ? "No matching users" : "No conversations yet"}
                description={search ? "Try a different search" : "Users will appear here when they message"}
              />
            </div>
          ) : (
        ...
        {selectedConversation ? (
          ...
          <div className="hidden sm:flex flex-1 items-center justify-center bg-gray-50">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">Click on a user to start replying</p>
            </div>
          </div>
        )}
      </div>
